...
def sliders():
    ...
    cv.createTrackbar("Hue Min","Bars", 0,179, sliders)
    cv.createTrackbar("Hue Max","Bars", 179,179, sliders)
    cv.createTrackbar("Sat Min","Bars", 0,255, sliders)
    cv.createTrackbar("Sat Max","Bars", 255,255, sliders)
    cv.createTrackbar("Val Min","Bars", 0,255, sliders)
    cv.createTrackbar("Val Max","Bars", 255,255, sliders)
    ...
    while True:
        ...
        # see these changes inside the image
